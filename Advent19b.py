...
def main():
    ...
    #modified rules to get regex for rule 11 had to look at reddit
    #kept adding 42/31 pattern until the answer didn't change
    rules[8] = ' 42 + '
    rules[11] = '  42 (?: 42 (?: 42 (?: 42 (?: 42 31 )? 31 )? 31 )? 31 )? 31 '
    #rules[8] = ' 42 | 42 8 '
